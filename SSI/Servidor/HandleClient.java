...
//    private final PublicKey serverPublicKey;
    ...
    HandleClient(Socket soc, int order, Server server) throws IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, InvalidKeySpecException, IllegalStateException, ShortBufferException, NoSuchProviderException, SignatureException, IllegalBlockSizeException, ClassNotFoundException, BadPaddingException {
        ...
        this.serverPrivateKey = (PrivateKey) Utils.loadKeyFile("server_pri.obj");
